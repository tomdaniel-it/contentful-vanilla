(() => {
    ...
    const generateRichHtmlNodes = (property, propertyEl) => {
        ...
        // TODO: (I'm tired, this is not the correct place for the todo) List of blogposts need to be clickable to other url with id
        // (so basically system for inserting the id into any attribute, maybe with 2 custom attributes? :
        // one to specify target attribute to replace, other to let js know the action needs to be done and potentially which prop to replace? (so maybe not only id))
